-- ฐานข้อมูลที่ปรับปรุงสำหรับระบบนิเวศประสิทธิภาพรถยนต์
-- ไฟล์นี้ขยายฐานข้อมูล CarCustomShop ด้วยคุณสมบัติห่วงโซ่อุปทานและบันทึกการสร้าง
...
-- ตารางชิ้นส่วนที่ปรับปรุง (MySQL สำหรับความสมบูรณ์ของข้อมูล)
...
CREATE TABLE IF NOT EXISTS BuildStage (
    ...
    Dependencies TEXT, -- JSON string ของขั้นตอนที่ต้องอาศัย
    CreatedDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS InventoryTransaction (
    ...
    UnitCost DECIMAL(10,2),
    TotalCost DECIMAL(12,2),
    ReferenceID INT, -- สามารถอ้างอิงถึง PurchaseOrderID, BuildProjectID, เป็นต้น
...
('admin', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj6ukx.LFvO6', 'admin', 'admin@automotive.com', 'ผู้ดูแลระบบ');

-- เพิ่มข้อมูลผู้จัดจำหน่ายตัวอย่าง
INSERT INTO Supplier (Name, ContactPerson, Email, Phone, Address) VALUES 
('Performance Parts Inc.', 'สมชาย ใจดี', 'orders@performanceparts.com', '555-0101', '123 Industrial Way, Detroit, MI 48201'),
('Speed Shop Supplies', 'สมศรี มั่นคง', 'info@speedshop.com', '555-0102', '456 Racing Blvd, Charlotte, NC 28206'),
('Turbo Dynamics', 'สมศักดิ์ เร็ว', 'sales@turbodynamics.com', '555-0103', '789 Boost Lane, Los Angeles, CA 90001');
